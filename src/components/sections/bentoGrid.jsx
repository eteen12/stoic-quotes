        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          <div className="relative lg:row-span-2">
            ...
            <div className="relative h-[44rem] grid grid-cols-1 grid-rows-[40%_60%] overflow-hidden text-xl">
              ...
              <div className="relative z-10 px-6 pt-20 grid grid-cols-1 grid-rows-[18%_18%_18%] lg:grid-rows-[20%_20%_20%] gap-5 w-full blackText tracking-tighter bold text-2xl md:text-3xl">
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10 grid grid-cols-1 grid-rows-[5%_70%_25%] h-[44rem] blackText tracking-tighter bold text-2xl md:text-3xl justify-items-center items-center text-center"></div>
            </div>
