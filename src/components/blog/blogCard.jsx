...
const BlogCard = ({ post }) => {
  return (
    <Link href={`/blog/${post.id}`}>
      <div className="flex flex-col overflow-hidden bg-white rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 transform hover:scale-105 text-black min-h-[500px]">
